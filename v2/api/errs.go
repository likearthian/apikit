...
var (
	...
	// ErrJWTKeyFuncMissing denotes JWT verification was configured without a
	// function for retrieving the token's verification key.
	ErrJWTKeyFuncMissing = errors.New("JWT key function is missing")
)
