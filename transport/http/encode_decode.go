...
type DecodeRequestFunc[I comparable] func(context.Context, *http.Request) (request I, err error)
...
type EncodeRequestFunc[I comparable] func(context.Context, *http.Request, I) error
...
type EncodeResponseFunc[O comparable] func(context.Context, http.ResponseWriter, O) error
...
type DecodeResponseFunc[O comparable] func(context.Context, *http.Response) (response O, err error)
